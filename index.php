...
<head>
    ...
    <meta name="keywords" content="iphone, github, loki, Dynamic island, team, loki-le best">
    <meta name="generator" content="Visual Studio Code">
    <meta name="publisher" content="by loki">

    <!-- CSS -->
    <link rel="stylesheet" href="style.css">
    <link rel="icon" href="R.ico">

    <title>Iphone 14 Dynamic Island using HTML and CSS only with Source Code - @code.scientist x @codingtorque
    </title>
</head>
